...
export const departmentDetailQuerySchema = Type.Object({
  include: Type.Optional(Type.Literal('employees')),
})
export type DeparmentDetailQuery = Static<typeof departmentDetailQuerySchema>
